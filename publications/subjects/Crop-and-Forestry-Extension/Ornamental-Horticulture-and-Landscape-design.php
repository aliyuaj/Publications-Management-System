<?php
$title='Publication: Crop Protection';
$location='../../../';
$publocation='../../';
...
<div class="col-md-6">
    <div>
        ...
        ?>
        <div style='font-family:"Trebuchet MS", Helvetica, sans-serif;font-size:30px;color:green;'><b> Crop Protection </b></div>
        <?php
        $per_page=5;
        $pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials left join categories ON materials.category=categories.catID left join subjects ON materials.subject=subjects.subjectID WHERE subjectName='Crop Protection' "));
        ...
        $query5=mysqli_query($con,"SELECT * from materials left join categories ON materials.category=categories.catID left join subjects ON materials.subject=subjects.subjectID WHERE subjectName='Crop Protection' LIMIT $start,$per_page");
