...
<head>
    ...
    <title>Publications: Seminar Papers</title>
    <!-- Bootstrap core CSS -->
...
<div class="container" id="cc">
    <div class="starter-template">
        <?php
        $per_page=20;
        $pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials WHERE  category= '2'"));
        ...
        $query=mysqli_query($con,"SELECT * from materials WHERE  category= '12' LIMIT $start,$per_page");
        $count=mysqli_num_rows($query);
        if(mysqli_num_rows($query)>0){
            echo ' <h2 style="font-family:Palatino Linotype;font-size:30px;color:green;">Seminar Papers</h2>';
            echo '<div class="table-responsive "><table class="table table table-bordered stay-center">';
