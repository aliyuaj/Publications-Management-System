...
<html lang="en">
  <head>
    ...
    <title>Publications: Newsletters</title>
    <!-- Bootstrap core CSS -->
...
<?php
			$per_page=20;
			$pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials WHERE  category= '10'"));
                    ...
                    $start=($page-1)*$per_page;
                        $query=mysqli_query($con,"SELECT * from materials WHERE  category= '10' LIMIT $start,$per_page");
                        $count=mysqli_num_rows($query);
					if(mysqli_num_rows($query)>0){
						echo ' <h2  style="font-family:Palatino Linotype;font-size:30px;color:green;">Newsletters</h2>';
						echo '<div class="table-responsive "><table class="table table-hover table table-bordered stay-center" style="min-width:50%">';
