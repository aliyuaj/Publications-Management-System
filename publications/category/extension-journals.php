...
<html lang="en">
  <head>
    ...
    <title>Publications: Extension Journals</title>
    <!-- Bootstrap core CSS -->
...
<?php
			$per_page=20;
			$pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials WHERE  category= '11'"));
                    ...
                    $start=($page-1)*$per_page;
                        $query=mysqli_query($con,"SELECT * from materials WHERE  category= '11' LIMIT $start,$per_page");
                        $count=mysqli_num_rows($query);
					if(mysqli_num_rows($query)>0){
						echo ' <h2 style="font-family:Palatino Linotype;font-size:30px;color:green;">Agric Extension Journals</h2>';
