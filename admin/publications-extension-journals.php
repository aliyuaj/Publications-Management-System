...
<head>
    ...
    <title>Admin Publications - Journals</title>
...
<?php					/****ALL JOURNALS****/
	echo '<div id="all">';
	$per_page=20;
	$pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials JOIN categories ON category=catID WHERE catName='Agric. Extension Journal'"));
	...
	$start=($page-1)*$per_page;
		$query5=mysqli_query($con,"SELECT * FROM materials JOIN categories ON category=catID WHERE catName='Agric. Extension Journal' LIMIT $start,$per_page");
		$count=mysqli_num_rows($query5);
	echo "<div style='font-family:Palatino Linotype;font-size:30px;color:green;' align='left'><b> Journals: </b>$pages_query</div>
