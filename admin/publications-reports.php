...
<head>
    ...
    <title>Admin Publications - Reports</title>
...
<div class="container" id="cc">
	<div class="starter-template">
	   ...
	   <?php					/****ALL REPORTS****/
			$per_page=20;
			$pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials JOIN categories ON category=catID WHERE catName='report'"));
			...
			$query5=mysqli_query($con,"SELECT * from materials JOIN categories ON category=catID WHERE catName='report' LIMIT $start,$per_page");
			$count=mysqli_num_rows($query5);
			echo "<div style='font-family:Palatino Linotype;font-size:30px;color:green;' align='left'><b>Reports: </b>$pages_query</div>
