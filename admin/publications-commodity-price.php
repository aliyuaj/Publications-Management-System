...
<head>
    ...
    <title>Publications: Admin Publications - Commodity Price</title>
...
<div class="container" id="cc">
	<div class="starter-template">
	   ...
	   <?php					/****ALL BULLETINS****/
		echo '<div id="all">';
	$per_page=20;
	$pages_query=mysqli_num_rows(mysqli_query($con,"SELECT * FROM materials JOIN categories ON category=catID WHERE catName='Commodity Price'"));
	if($pages_query>0) {
        ...
        $query5 = mysqli_query($con, "SELECT * FROM materials JOIN categories ON category=catID WHERE catName='Commodity Price' LIMIT $start,$per_page");
        $count = mysqli_num_rows($query5);
        echo "<div style='font-family:Palatino Linotype;font-size:30px;color:green;' align='left'><b>Commodity Price: </b>$pages_query</div>
